(global.webpackJsonp = global.webpackJsonp || []).push([ [ "pages/detail/detail" ], {
    ...
    "31e3": function(t, a, o) {
        ...
        o("2930");
        var d = o("f0c5"), s = Object(d.a)(i.default, e.b, e.c, !1, null, "4496cd9e", null, !1, e.a, void 0);
        a.default = s.exports;
    },
    "5a6e": function(t, a, o) {
        o.d(a, "b", function() {
        ...
        var e = {
            uniBar: function() {
                return Promise.all([ o.e("common/vendor"), o.e("components/uni-bar/uni-bar") ]).then(o.bind(null, "9a28"));
            },
            narBar: function() {
                return o.e("components/narBar/narBar").then(o.bind(null, "0b0a"));
            },
            uniRate: function() {
                return Promise.all([ o.e("common/vendor"), o.e("components/uni-rate/uni-rate") ]).then(o.bind(null, "1cf5"));
            },
            customAd: function() {
                return o.e("components/custom-ad/custom-ad").then(o.bind(null, "dac9"));
            },
            uniAd: function() {
                return o.e("components/uni-ad/uni-ad").then(o.bind(null, "e53c"));
            },
            vodItem: function() {
                return o.e("components/vod-item/vod-item").then(o.bind(null, "7534"));
            },
            message: function() {
                return o.e("components/message/message").then(o.bind(null, "6def"));
            }
        }, i = function() {
            var t = this;
            t.$createElement;
    ...
    "959d": function(t, a, o) {
        (function(t) {
            ...
            var o = getApp().globalData, e = null, i = {
                data: function() {
                    return {
                        theme: o.$theme,
                        voddata: [],
                ...
                onLoad: function(a) {
                    this.vodid = a.id, t.getStorageSync("$voddata").vod_id == this.vodid && (this.voddata = t.getStorageSync("$voddata"));
                    var e = this;
                ...
                onShow: function() {
                    var t = this;
                    t.isBack && t.interstitialAd && t.interstitialAd.show().catch(function(t) {
                        console.error(t);
                    });
                },
                methods: {
                    ...
                    init: function() {
                        ...
                        })).onLoad(function() {}), e.onError(function(t) {}), e.onClose(function(a) {
                            if (a && a.isEnded) {
                                o.$points = !1, i.playType(), e.destroy();
                    ...
                    refresh: function(a) {
                        var e = this, i = this;
                        this.WxVerify = o.$wxverify, t.showLoading({
                            mask: !0,
                            title: "加载中..."
                        });
                    ...
                    poster: function(a, e) {
                        var i = this;
                        a = JSON.stringify(a), t.showLoading({
                            mask: !0,
                            title: "正在生成..."
                        });
                    ...
                    adTab: function() {
                        ...
                        e.show().catch(function() {
                            e.load().then(function() {
                                ...
                                e.destroy(), o.$points = !1, t.playType();
                            });
                        });
                    },
                    playType: function() {
                    ...
                    navigate: function() {
                        t.setStorageSync("$web", o.$config.detail.gzh.pic), t.navigateTo({
                            url: "../web/web"
                        });
                    },
                    BackPage: function() {
    ...
    "97aa": function(t, a, o) {
        (function(t) {
            ...
            o("3079"), a(o("66fd")), t(a(o("31e3")).default);
        }).call(this, o("543d").createPage);
    },
    ab0d: function(t, a, o) {}
}, [ [ "97aa", "common/runtime", "common/vendor" ] ] ]);
