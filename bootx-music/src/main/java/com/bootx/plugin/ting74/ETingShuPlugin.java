...
public class ETingShuPlugin extends MusicPlugin {
    ...
    public Map<String, Object> getCategoryList(String url) {
        ...
        if(
                StringUtils.equalsAnyIgnoreCase(baseUrl+"top/allvisit.html",url)
                        ||StringUtils.equalsAnyIgnoreCase(baseUrl+"over/",url)
                        ||StringUtils.equalsAnyIgnoreCase(baseUrl+"top/votenum.html",url)
                        ||StringUtils.equalsAnyIgnoreCase(baseUrl+"top/lastupdate.html",url)
                        ||StringUtils.equalsAnyIgnoreCase(baseUrl+"top/postdate.html",url)
        )
        {
            return other(url);
        }
