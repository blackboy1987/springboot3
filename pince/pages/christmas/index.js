            ...
            var s = i(a("f47e")), n = i(a("94f5")), o = [], c = 1, r = !0, l = 0, h = getApp(), u = new n.default(), d = {
                ...
                methods: {
                    changhat: function(e, a) {
                        var i = this;
                        e.lock ? u.useQQAd(this.videoAd).then(function(s) {
                            if (s) {
                    ...
                    getlist: function() {
                        ...
                        t.request({
                            ...
                            success: function(a) {
                                e.hatlist = a.data.hatlist, e.hatlistlength = a.data.hatlist.length;
                                ...
                                h.globalData.christmas.adUnitId = "2d6090694b3f3898476f022ad34f3fad", h.globalData.christmas.hasAd = a.data.hasAd,
                    ...
                    drawimg: function(e) {
                        ...
                        t.getImageInfo({
                            src: this.showimg,
                            success: function(s) {
                                a.sideness ? (i.drawImage(s.path, 0, 0, 640, 640), i.translate(2.5 * a.itemList[0].x, 2.5 * a.itemList[0].y),
                                ...
                                i.rotate((360 - a.itemList[0].rotate) * Math.PI / 180), i.translate(-2.5 * a.itemList[0].x, -2.5 * a.itemList[0].y)) : (i.fillStyle = "#ffffff",
                                i.fillRect(0, 0, 640, 640), i.stroke(), i.beginPath(), i.save(), i.arc(320, 320, 320, 0, 2 * Math.PI),
                                i.stroke(), i.clip(), i.drawImage(s.path, 0, 0, 640, 640), i.translate(2.5 * a.itemList[0].x, 2.5 * a.itemList[0].y),
                                i.rotate(-(360 - a.itemList[0].rotate) * Math.PI / 180), i.drawImage(a.itemList[0].path, -a.itemList[0].width * a.itemList[0].scale * 2.5 / 2, -a.itemList[0].height * a.itemList[0].scale * 2.5 / 2, a.itemList[0].width * a.itemList[0].scale * 2.5, a.itemList[0].height * a.itemList[0].scale * 2.5),
                                i.rotate((360 - a.itemList[0].rotate) * Math.PI / 180), i.translate(-2.5 * a.itemList[0].x, -2.5 * a.itemList[0].y),
                                i.restore(), i.closePath()), i.draw(!1, function() {
                                    setTimeout(function() {
                    ...
                    start: function(t) {
                        this.starticon.x = t.currentTarget.offsetLeft,
                        this.starticon.y = t.currentTarget.offsetTop;
                    },
                    ...
                    WraptouchStart: function(t) {
                        for (var e = 0; e < o.length; e++) o[e].active = !1, t.currentTarget.dataset.id == o[e].id && (o[l = e].active = !0);
