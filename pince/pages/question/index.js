    ...
    f371: function(t, e, s) {
        (function(t) {
            ...
            var n = a(s("f47e")), o = s("c7c6"), r = a(s("94f5")), u = a(s("6f91")), l = a(s("1418")), c = getApp(), d = 1, h = "https://ssl-uploads-admin.cdn.itwlw.com/", g = new r.default(), p = {
                ...
                onLoad: function(e) {
                    var s = this;
                    this.ads = wx.getStorageSync("appConfig").indexAd || {};
                ...
                methods: {
                    initQuestion: function(e) {
                        ...
                        const indexAd = wx.getStorageSync("appConfig").indexAd || {};
                        e.id && (a.id = e.id), e.q && (a.q = e.q), t.request({
                            ...
                            success: function(t) {
                                ...
                                i = i.map(function(t, e) {
                                    ...
                                    t;
                                }), a.video_ad_utilid && a.video_ad_utilid;
                                try {
                    ...
                    verifyUserInfo: function(e) {
                        t.request({
                            ...
                            success: function(s) {
                                0 == s.data.avatar_status && (c.globalData.user.avatarUrl = s.data.url),
                        ...
                        new Promise(function(a, i) {
                            ...
                            new Promise(function(t, n) {
                                if (console.log(333333333), a && a.draw_config) {
                                    ...
                                    0 != c.globalData.user.verify || e.nouserInfo ? ("center" == o.align ? s.fillText(e.userInfo.nickName, o.x ? o.x : 320, o.y) : ("right" == o.align || "left" == o.align) && s.fillText(e.userInfo.nickName, o.x, o.y),
                                    t()) : e.verifyUserInfo(function() {
                                        "center" == o.align ? s.fillText(e.userInfo.nickName, o.x ? o.x : 320, o.y) : ("right" == o.align || "left" == o.align) && s.fillText(e.userInfo.nickName, o.x, o.y),
                                        t();
                                    });
                                } else t();
                            }).then(function() {
                    ...
                    showResult: function(t) {
                        ...
                        setTimeout(function() {
                            e.scaleAnmia = !0, e.videolockBox = s, setTimeout(function() {
                    ...
                    openQzone: function(t) {
                        ...
                        n.default.Event.stat("shareqzone", {
                            gid: this.id,
                            qzonetype: 2
                        }), e = this.share_shuoshuo_title ? this.share_shuoshuo_title : this.question.title,
                        3 == this.question.subscribe_status && setTimeout(function() {
                            s.addDingYue(s.question.subscribe_status);
