(global.webpackJsonp = global.webpackJsonp || []).push([ [ "p/i" ], {
            ...
            var i = o(e("81ab")), r = o(e("2e96")), s = o(e("1b15")), l = o(e("a35f")), c = o(e("f47e")), d = e("4e22"), u = e("c7c6"), p = getApp(), g = {
                data: function() {
                    ...
                    return n(a = {
                        ...
                        groupicon: r.default,
                        showgroupBox: !0
                    }, "showgroupBox", !1), n(a, "qqGroupid", ""), n(a, "navData", ""), a;
                },
                onLoad: function(t) {
                    var e = this;
                    c.default.Page.init();
                    var o = {};
                    if (t.scene && ( decodeURIComponent(t.scene).split("&").forEach(function(a, t) {
                ...
                methods: {
                    initHome: function(t) {
                        ...
                        o.history_app = r.join(), a.request({
                            ...
                            success: function(o) {
                                ...
                                e.latest = e.latest.concat(c), 1 == e.pageIndex && (e.featured = e.latest),
                                o.data.scandata && (0, u.playGame)(o.data.scandata);
                                var g = o.data.newScanData ? o.data.newScanData : {};
                                e.showtestbox = g.showScanbox, t.g && (g.showScanbox ? e.showtestbox = g.showScanbox : (0,
                                u.playGame)({
                                    gid: t.g
                        ...
                        this.load && (this.load = !1, a.request({
                            ...
                            success: function(a) {
                                if (200 == a.statusCode) {
                                    ...
                                    t.latest = t.latest.concat(e).shift(), 1 == t.pageIndex && (t.featured = t.latest),
                                    t.pageIndex += 1;
                                }
                                t.load = !0, that.latest.shift();
                            },
                            fail: function(a) {
                                t.load = !0;
                            }
                    ...
                    showboxBanner: function() {
                        var a = this;
                        this.boxVideoAd.load().then(function() {
                            a.boxVideoAd.show();
                        ...
                        c.default.Event.stat("navigateMiniProgram", {
                            ...
                            success: function(n) {
                                c.default.Event.stat("navigateMiniProgram", {
                                    ...
                                    hasstar: 0
                                }), a.setStorageSync("star", t),  e.selectstar = !1, e.initHome({});
                            }
                        });
                    }
                }
    ...
    f4a6: function(a, t, e) {
        var o = function() {
            var a = this;
            a.$createElement, a._self._c, a._isMounted || (a.e0 = function(t) {
                a.showgroupBox = !1;
            });
        }, n = [];
        e.d(t, "a", function() {
