...
public class ImageListPojo extends BaseResponse {

    @JsonProperty("guid_info")
    private String guidInfo;
    private List<ListDTO> info = new ArrayList<>();
    ...
    public List<ListDTO> getInfo() {
        return info;
    }

    public void setInfo(List<ListDTO> list) {
        this.info = list;
    }
